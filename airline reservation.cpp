...
public:
    LinkedList ticketList; // Linked list for storing booked tickets
...

 {
        ...
        outf.close();
        // Add booked ticket to the linked list
        ticketList.insert(Details::cId);
    }
...
void mainMenu() {
    ...
    while (lchoice) {
        ...
        case 2: {
            cout << "________Book a flight using this system____________\n" << endl;
            r.flights();
            break;
        }
        case 3: {
